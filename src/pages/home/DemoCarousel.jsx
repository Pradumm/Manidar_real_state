...
function DemoCarousel() {
    ...
    return (
        ...
        <>
            ...
            <div
                id="carouselId"
                className='container mx-auto py-6 px-4 lg:px-10'>
                            ...
                            return (
                                <>
                                    <div className='border bg-white md:mx-5'>
                                        <div className=' relative w-full h-80  lg:h-96 bg-center  bg-no-repeat bg-cover' style={{ backgroundImage: `url("https://rexararealty.com/uploads/gallery/PhotoAG00009-1.jpeg")` }} >
