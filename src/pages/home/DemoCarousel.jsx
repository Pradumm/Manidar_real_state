...
//             {" "}
//             single-family homes or embrace the convenience of city living with
//             our vibrant downtown properties.
//           </p>
//         </div>
...
//             return (
//               <>
//                 <div className="border bg-white md:mx-5">
//                   <div
//                     className=" relative w-full h-80  lg:h-96 bg-center  bg-no-repeat bg-cover"
//                     style={{
//                       backgroundImage: `url("https://rexararealty.com/uploads/gallery/PhotoAG00009-1.jpeg")`,
//                     }}
//                   >
...
//                         {" "}
//                         <IoBedOutline className="w-5 h-5" />3
//                       </span>
//                       <span className="flex justify-center items-center gap-3">
//                         {" "}
