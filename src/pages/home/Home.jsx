      ...
      <section className='container mx-auto py-6 lg:pt-20 lg:pb:14 px-4 lg:px-10'>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 ">
          <div class="col-span-1 parent-div  py-28  lg:py-40 bg-cover bg-no-repeat shadow overflow-hidden relative flex items-center justify-center"
            style={{ backgroundImage: `url("./img/wp7733723-luxury-home-wallpapers.jpg")` }}>
          ...
          <div class="col-span-1 parent-div  py-28  lg:py-40 bg-cover bg-no-repeat  shadow overflow-hidden relative flex items-center justify-center"
            style={{ backgroundImage: `url("./img/wp6671464-luxury-life-wallpapers.jpg")` }}>
            <div class="   bg-black bg-opacity-70 hover:bg-opacity-0 z-50  text-center absolute inset-0 flex items-center justify-center ">
              <div className='flex flex-col'>
          ...
          <div class="col-span-1 parent-div  py-28  lg:py-40 bg-cover bg-no-repeat  shadow overflow-hidden relative flex items-center justify-center"
            style={{ backgroundImage: `url("./img/wp3982700-house-wallpapers.jpg")` }}>
            <div class="   bg-black bg-opacity-70 hover:bg-opacity-0 z-50  text-center absolute inset-0 flex items-center justify-center ">
              <div className='flex flex-col'>
          ...
          <div class="col-span-1 parent-div  py-28  lg:py-40 bg-cover bg-no-repeat  shadow overflow-hidden relative flex items-center justify-center"
            style={{ backgroundImage: `url("./img/wp3701682-luxury-homes-wallpapers.jpg")` }}>
            <div class="   bg-black bg-opacity-70 hover:bg-opacity-0 z-50  text-center absolute inset-0 flex items-center justify-center ">
              <div className='flex flex-col'>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="col-span-1 parent-div  py-28  lg:py-40 bg-cover bg-no-repeat shadow overflow-hidden relative flex items-center justify-center"
            style={{ backgroundImage: `url("./img/wp3701651-luxury-homes-wallpapers.jpg")` }}>
            <div class="   bg-black bg-opacity-70 hover:bg-opacity-0 z-50  text-center absolute inset-0 flex items-center justify-center ">
              <div className='flex flex-col'>
          ...
          <div class="col-span-1 parent-div w-full py-28  lg:py-40 bg-cover bg-no-repeat  shadow overflow-hidden relative flex items-center justify-center"
            style={{ backgroundImage: `url("./img/61378d9cd055f908dfcbc33a_classic-custom-kitchen-antique-woodwork-luxury hand-carved-hood-new-jersey-05.jpg")` }}>
            <div class="   bg-black bg-opacity-70 hover:bg-opacity-0 z-50  text-center absolute inset-0 flex items-center justify-center ">
              <div className='flex flex-col'>
          ...
          <div class="col-span-1 parent-div  py-28  lg:py-40 bg-cover bg-no-repeat  shadow overflow-hidden relative flex items-center justify-center"
            style={{ backgroundImage: `url("./img/robyn-bessenger-photography-34.jpeg")` }}>
            <div class="   bg-black bg-opacity-70 hover:bg-opacity-0 z-50  text-center absolute inset-0 flex items-center justify-center ">
              <div className='flex flex-col'>
