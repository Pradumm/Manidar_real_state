                ...
                <div className="">
                    ...
                    <div className='container px-4  lg:px-10 mx-auto '>
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-0'>
                            ...
                            <div className=" bg-cover bg-center h-[12rem] md:h-96" style={{ backgroundImage: `url(${seller})` }}>
                        ...
                        <div className=' grid grid-cols-1 lg:grid-cols-2 mt-4 lg:mt-0 gap-4 lg:gap-0'>
                            ...
                            <div className=" bg-cover bg-center h-[12rem] md:h-96 order-2 lg:order-1 " style={{ backgroundImage: `url(${seller2})` }}>
