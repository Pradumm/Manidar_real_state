                                    ...
                                    <table className="w-full text-sm text-left rtl:text-right">
                                        ...
                                        <tbody>
                                            <tr className="bg-white border">
                                                <td className="px-4 border py-1.5">{property["Status:"]}</td>
                                                <td className="px-4 border py-1.5">{property["MLS® Num:"]}</td>
                                                <td className="px-4 border py-1.5">{property["Bedrooms:"]}</td>
                                                <td className="px-4 border py-1.5">{property["Bathrooms:"]}</td>
                                                <td className="px-4 border py-1.5">{property["mrp-listing-price-container"]}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
