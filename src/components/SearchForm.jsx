    ...
    return (
        <>
            ...
            <form class=" w-full  text-[#464646]">
                <div>
                    <h2 className='text-2xl text-black font-normal mb-4'>Advanced Search</h2>
                </div>
                <div className='mb-3'>
                    <input
                ...
                <div className='mb-3'>
                    <select id="countries" class=" border border-gray-300 text-sm rounded-lg  focus:outline-none block w-full p-2.5   ">
                ...
                <div className='mt-6'>
                    <button
                        class=" border text-white bg-NewYello border-gray-300 text-sm rounded-lg  focus:outline-none block w-full p-2.5 "
